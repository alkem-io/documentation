...
A basic posts contains a title and an optional description. In the description you can add text formatting, references, embedded media and images, making it easy to communicate updates or gather input from members.
...
You can choose to add additional content to the post. For now, the only options is a whiteboard, but there will be more in the future.
...
There are 2 types of response options you can set up for your posts to enable collaboration within the community. The 2 types are described below.

![Response options](/response-options.png)

### Comments
Enable comments (this is the default setting) if you want the community to be able to reply to the post. This can be usefull to initiate a discussion or ask for input f.e.
...
- A specific template for the posts, containing guiding questions or a structure f.e.
...
When contributing to a Collection of Post, hit the '+' button and the window opens up with a text editor prefilled by the creator of the Collection of Posts. Fill in a title and fill up the description following the instructions in the text editor.
...
- **A basic post** on the **Dashboard Tab** to ask for comments, suggestions, feedback.
...
- **A basic post** on the **Community Tab** to ask members to introduce themselves or suggest other people/organizations to invite (see example below).
- **A Collection of Posts** on the **Subspaces Tab** where members can submit ideas for creating Subspaces to work in by filling in a few context questions.
- **A Collection of Links** with relevant articles related to the topic on the **Knowledge Base Tab**.
