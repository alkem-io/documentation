...
A Poll lets you gather structured input from your community by asking members to vote on predefined options. Polls are ideal for making decisions together, gauging sentiment, or prioritising ideas.
...
- Browse images in an inline carousel, without leaving the page.
- Individual images can be downloaded.

Clicking any image opens the full carousel view.
