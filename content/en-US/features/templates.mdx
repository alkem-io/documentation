...
- Add Templates from the Template Library – Import existing templates from the platform-wide Template Library to use in your Space.
...
- This opens a selection of templates, organized as follows:
  ...
  - Templates from the Template Library (platform-wide) appear below.
...
- Just like before, Space Templates appear first, followed by Template Library templates.
