# Use Excalidraw whiteboards

Prefer exploring these tips on a whiteboard straight away? [Click here to open the corresponding whiteboard in the Welcome Space](https://alkem.io/welcome-space/collaboration/whiteboardtipstricks).
...
#### Separating the border color from the text color
